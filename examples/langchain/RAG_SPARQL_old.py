...
@timed_function
def extract_entities_and_classify(question: str, query_matches, entity_matches, ontology_content, history) -> (str, str):
    try:
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "If SPARQL is relevant for a RAG query, especially when Entity Matches (similarity search results) contains useful entity information, construct a SPARQL query utilizing this data. "
...
async def RAGandSPARQL(question, history):
    ...
    extract_task = loop.run_in_executor(executor, extract_entities_and_classify, question, query_search_results, initial_matches, ontology_content, history)
